...
<html lang="en">
  ...
  <nav class="mb-1 navbar navbar-expand-lg navbar-dark blue-grey">
    ...
    <div class="container-fluid" style="background-image: url(img/chimpanzee1.jpg);background-size: cover; height: 100%;background-position: center;">
      <div class="row">
        <div class="offset-2 col-4 text-white" style="margin-top: 165px; margin-left: 100px;">
...
<div class="card" style="margin-top: 165px; margin-bottom: 70px; margin-left: 520px;">
    ...
    <div class="card-body px-lg-5 pt-0">
        ...
        <form class="text-center" style="color: #757575;" action="#!">
            ...
            <div class="md-form mt-0">
                ...
                <label for="materialRegisterFormEmail">Adresse</label>
            </div>
            ...
            <!-- Sign up button -->
            <button class="btn btn-outline-info btn-rounded btn-block my-4 waves-effect z-depth-0" type="submit">Sign petition</button>
