...
mysqli_report(MYSQLI_REPORT_ERROR | MYSQLI_REPORT_STRICT);
    ...
    class DonationDataAccess extends ConnexionDDB  {
        ...
        function ajoutDon(Donation $don)
        {
            ...
            $db->query('INSERT INTO don VALUES (null,'.$don->getAnimal().')');
            $stmt = $db->prepare('INSERT INTO effectuer VALUES ((SELECT MAX(id_don) FROM don),'.$don->getUser().',"'.$don->getDate().'", ?,"'.$don->getFrequence().'")');
